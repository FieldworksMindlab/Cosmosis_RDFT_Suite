...
That opens Processing on this sketch folder and SuperCollider on `ColdSun_ShimmerB.scd`, and starts the same optional solar, ocean, galaxy, and surface bridge processes when available.
