...
void loadGalaxyMap(String name) {
  ...
  try {
    ...
    galaxyThermalExcit    = j.getFloat("thermal_excitation");
    ...
    println("GalaxyMapLoader: " + galaxyStatus +
            ...
            " th=" + safeNf(galaxyThermalExcit,1,2) +
...
void drawGalaxyPanel(int x, int y, int w, int h) {
  ...
  drawMiniReadout(rx, ry + 48, rw, "thermal",     galaxyThermalExcit,    safeNf(galaxyThermalExcit,1,2));
